...
import PassaporteCheckoutModal from "./PassaporteCheckoutModal";
...
const Passaportes = () => {
  ...
  const cardInfo = [
    {
      ...
      price: "497,00",
      checkoutUrl: "https://www.sympla.com.br/evento/sintonia-de-mulher-2026/3352903",
    },
    {
      titulo: "SETOR",
      destaque: "PISTA",
  ...
  return (
    <>
              ...
              <div className="relative z-20 flex h-full flex-col justify-between rounded-3xl border border-black/20 bg-[#f4f3ea] p-10 shadow-[0_15px_35px_rgba(0,0,0,0.15)]">
                ...
                <div className="mt-10 text-center">
                  ...
                  <div className="mt-2 flex items-end justify-center gap-2">
                    ...
                    <span className="text-7xl font-bold leading-none text-[#7A2E33] select-none sm:text-8xl">
                      {card.price.split(",")[0]}
                    </span>
                    <span className="text-2xl text-[#7A2E33] select-none">
                      ,{card.price.split(",")[1]}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-center pt-1">
                    <div className="w-fit rounded-[22px] bg-white p-[1px] shadow-[0_0_5px_rgba(0,0,0,0.4)]">
                      <div className="rounded-[22px] bg-gradient-to-r from-[#D85A66] via-[#9E2F3F] to-[#9E2F3F] px-6 py-3 sm:px-8">
                        <button
                          type="button"
                          onClick={() => setSelectedPassport(card)}
      ...
      <PassaporteCheckoutModal
        isOpen={Boolean(selectedPassport)}
        onClose={() => setSelectedPassport(null)}
        categoryLabel={selectedPassport?.destaque}
        checkoutUrl={selectedPassport?.checkoutUrl || "#"}
      />
    </>
  );
};
